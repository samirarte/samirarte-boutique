...
<header class="sam-header">
	<div class="sam-header__inner">
		<div class="sam-mobile-shell" aria-label="<?php echo esc_attr__( 'Cabecera móvil Samirarte', 'samirarte-boutique' ); ?>">
			...
			<div id="sam-mobile-menu" class="sam-mobile-menu" hidden>
				...
				<div class="sam-mobile-menu__utilities">
					<a class="sam-mobile-account-link<?php echo esc_attr( $account_current_class ); ?>" href="<?php echo esc_url( $account_url ); ?>"<?php echo $account_current_class ? ' aria-current="page"' : ''; ?>>
		...
		<div class="sam-header-actions">
			<a class="sam-button sam-button--account<?php echo esc_attr( $account_current_class ); ?>" href="<?php echo esc_url( $account_url ); ?>"<?php echo $account_current_class ? ' aria-current="page"' : ''; ?>>
