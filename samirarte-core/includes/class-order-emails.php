			...
			$emails = array(
				'pending'           => array(
					...
					'message' => sprintf(
						...
						__( 'Hemos recibido tu pedido #%s.<br>Para confirmarlo, realiza el Bizum al +34676679064 indicando la referencia del pedido.', 'samirarte-core' ),
						$order_number
					),
				),
							...
							<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #f4e6cf;">
								...
								<tr>
									<td style="padding:22px 30px;background:#f4e6cf;color:#4b2e22;font-size:14px;line-height:1.6;">
										...
										<p style="margin:0"><?php echo esc_html( '+34676679064' ); ?></p>
										<p style="margin:0;"><a href="https://wa.me/34676679064" style="color:#4b2e22;text-decoration:none;">WhatsApp</a></p>									</td>
								</tr>
							</table>
						</td>
					</tr>
