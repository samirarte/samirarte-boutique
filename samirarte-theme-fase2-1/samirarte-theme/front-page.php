	...
	<section class="feature-section feature-cajas">
		<div class="samirarte-container feature-grid">
			...
			<div class="feature-copy">
				...
				<a class="text-link" href="<?php echo esc_url( home_url( '/tienda/' ) ); ?>">
					<?php esc_html_e( 'Ver tienda', 'samirarte-theme' ); ?>
				</a>
			</div>
		</div>
	</section>
	...
	<section class="story-section">
		<div class="samirarte-container story-panel">
			<div class="story-copy">
				...
				<a class="button button-dark" href="<?php echo esc_url( home_url( '/cuentos/' ) ); ?>">
					<?php esc_html_e( 'Conocer los cuentos', 'samirarte-theme' ); ?>
				</a>
			</div>
	...
	<section class="closing-section">
		<div class="samirarte-container closing-inner">
			...
			<div class="hero-actions">
				...
				<a class="button button-secondary" href="<?php echo esc_url( home_url( '/contacto/' ) ); ?>">
					<?php esc_html_e( 'Contactar', 'samirarte-theme' ); ?>
				</a>
			</div>
		</div>
	</section>
